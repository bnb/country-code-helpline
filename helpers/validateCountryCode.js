// this is a function that validates external untrusted input.
// we're only expecting up to three digits, so it's 
// theoretically pretty straightforward to manage.
//
